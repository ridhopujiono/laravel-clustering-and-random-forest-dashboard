...
<body class="bg-slate-50 text-slate-800">
        <div id="auth" class="flex min-h-screen">
            ...
            <div class="w-full md:w-1/2 flex flex-col justify-center items-center p-8 lg:p-16">
                <div class="w-full max-w-md">
                    <div class="text-center md:text-left mb-10">
                        ...
                        <svg class="w-12 h-12 mx-auto md:mx-0 mb-4 text-teal-600" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M18 21a4 4 0 00-4-4H9a4 4 0 00-4 4" />
                        </svg>
                    ...
                    <form action="{{ route('auth') }}" method="POST">
                        ...
                        <!-- Input Email -->
                        <div class="mb-4">
                            <label for="email" class="block mb-2 text-sm font-medium text-slate-700">Alamat
                                Email</label>
                            <div class="relative">
                                ...
                                <input type="email" name="email" id="email"
                                    class="bg-white border border-slate-300 text-slate-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full pl-10 p-2.5"
                        ...
                        <!-- Input Password -->
                        <div class="mb-6">
                            <label for="password" class="block mb-2 text-sm font-medium text-slate-700">Kata
                                Sandi</label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                                    <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor"
                        ...
                        <!-- Tombol Login -->
                        <button type="submit"
                            class="w-full text-white bg-teal-600 hover:bg-teal-700 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-3 text-center transition duration-300 ease-in-out">Masuk</button>
                    </form>
                </div>
            </div>
            ...
            <div class="hidden md:block w-1/2 relative bg-white">
                ...
                <div
                    class="content-overlay flex flex-col justify-center items-center h-full p-16 text-center bg-white bg-opacity-25">
                    <h2 class="text-4xl font-bold leading-tight text-slate-900">Memetakan Pertumbuhan, <br>Mencegah
                        Stunting.</h2>
                    <p class="mt-4 text-lg text-slate-600 max-w-lg">Platform kami membantu mengidentifikasi pola dan
                        risiko stunting melalui analisis klaster untuk intervensi yang lebih dini dan efektif.</p>
                </div>
            </div>
